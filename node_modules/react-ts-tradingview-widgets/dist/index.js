...
var Copyright = function (_a) {
    ...
    return (React__default["default"].createElement("div", { style: Object.assign({}, defaultStyles.parent, copyrightStyles === null || copyrightStyles === void 0 ? void 0 : copyrightStyles.parent) },
        React__default["default"].createElement("a", { style: Object.assign({}, defaultStyles.link, copyrightStyles === null || copyrightStyles === void 0 ? void 0 : copyrightStyles.link), href: href, target: "_blank" },
            React__default["default"].createElement("span", { style: Object.assign({}, defaultStyles.span, copyrightStyles === null || copyrightStyles === void 0 ? void 0 : copyrightStyles.span) },
                spanText,
                " ")),
        text));
};
...
var SymbolOverview = function (_a) {
    var _b = _a.symbols, symbols = _b === void 0 ? defaultSymbols$2 : _b, _c = _a.chartOnly, chartOnly = _c === void 0 ? false : _c, _d = _a.width, width = _d === void 0 ? 1000 : _d, _e = _a.height, height = _e === void 0 ? 400 : _e, _f = _a.locale, locale = _f === void 0 ? "en" : _f, _g = _a.colorTheme, colorTheme = _g === void 0 ? "light" : _g, _h = _a.gridLineColor, gridLineColor = _h === void 0 ? "rgba(42, 46, 57, 0)" : _h, _j = _a.fontColor, fontColor = _j === void 0 ? "#787B86" : _j, _k = _a.isTransparent, isTransparent = _k === void 0 ? false : _k, _l = _a.showFloatingTooltip, showFloatingTooltip = _l === void 0 ? true : _l, _m = _a.scalePosition, scalePosition = _m === void 0 ? "no" : _m, _o = _a.scaleMode, scaleMode = _o === void 0 ? "Normal" : _o, _p = _a.fontFamily, fontFamily = _p === void 0 ? "Trebuchet MS, sans-serif" : _p, _q = _a.noTimeScale, noTimeScale = _q === void 0 ? false : _q, _r = _a.chartType, chartType = _r === void 0 ? "area" : _r, 
    //area
    _s = _a.lineColor, 
    //area
    lineColor = _s === void 0 ? "#2962FF" : _s, _t = _a.bottomColor, bottomColor = _t === void 0 ? "rgba(41, 98, 255, 0)" : _t, _u = _a.topColor, topColor = _u === void 0 ? "rgba(41, 98, 255, 0.3)" : _u, 
    //bars & candles
    _v = _a.upColor, 
    //bars & candles
    upColor = _v === void 0 ? "#26a69a" : _v, _w = _a.downColor, downColor = _w === void 0 ? "#ef5350" : _w, 
    //candles
    _x = _a.borderUpColor, 
    //candles
    borderUpColor = _x === void 0 ? "#26a69a" : _x, _y = _a.borderDownColor, borderDownColor = _y === void 0 ? "#ef5350" : _y, _z = _a.wickUpColor, wickUpColor = _z === void 0 ? "#26a69a" : _z, _0 = _a.wickDownColor, wickDownColor = _0 === void 0 ? "#ef5350" : _0, _1 = _a.autosize, autosize = _1 === void 0 ? false : _1, _2 = _a.container_id, container_id = _2 === void 0 ? "tradingview_".concat(createId(5)) : _2, copyrightStyles = _a.copyrightStyles, props = __rest(_a, ["symbols", "chartOnly", "width", "height", "locale", "colorTheme", "gridLineColor", "fontColor", "isTransparent", "showFloatingTooltip", "scalePosition", "scaleMode", "fontFamily", "noTimeScale", "chartType", "lineColor", "bottomColor", "topColor", "upColor", "downColor", "borderUpColor", "borderDownColor", "wickUpColor", "wickDownColor", "autosize", "container_id", "copyrightStyles"]);
    return (React__default["default"].createElement("div", { id: "tradingview_widget_wrapper" },
        React__default["default"].createElement(Widget, { scriptHTML: __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({ symbols: symbols, chartOnly: chartOnly }, (!autosize ? { width: width } : { width: "100%" })), (!autosize ? { height: height } : { height: "100%" })), { locale: locale, colorTheme: colorTheme, gridLineColor: gridLineColor, fontColor: fontColor, isTransparent: isTransparent, showFloatingTooltip: showFloatingTooltip, scalePosition: scalePosition, scaleMode: scaleMode, fontFamily: fontFamily, noTimeScale: noTimeScale, chartType: chartType }), (chartType === "area" && { lineColor: lineColor, bottomColor: bottomColor, topColor: topColor })), ((chartType === "bars" || chartType === "candlesticks") && {
                upColor: upColor,
                downColor: downColor,
            })), (chartType === "candlesticks" && {
            ...
            })), { autosize: autosize, container_id: container_id }), props), scriptSRC: "https://s3.tradingview.com/tv.js", containerId: container_id, type: "MediumWidget" }),
